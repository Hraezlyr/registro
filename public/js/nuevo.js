...
nuevo.addEventListener("click",function() {
  ...
  '<div class="col-start-1 col-end-3"><label for="nombre_hijo" class="block text-sm font-medium text-gray-700">Nombre</label>'+
  ...
  '<div class="col-start-3 col-end-5">'+
    '<label for="sexo" class="block text-sm font-medium text-gray-700">Sexo</label><select id="sexo" name="sexo[]" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">'+
    '<option value="femenino">Femenino</option>'+
    '<option value="masculino">Masculino</option>'+
    '</select></div><div class="col-start-5">'+
